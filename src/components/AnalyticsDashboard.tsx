...
export const AnalyticsDashboard: React.FC = () => {
  ...
  const statusData: StatusData[] = Object.entries(ordersByStatus).map(([status, count]) => ({
    name: status,
    value: count
  }));

  // Calculate orders by date (last 7 days)
  const last7Days: DateData[] = Array.from({ length: 7 }, (_, i) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Orders by Date (Last 7 Days)</h3>
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
