...
export const ChangeRequestsTable = () => {
    ...
    const shouldUppercase = (name, value) => {
        // Don't uppercase empty values
        if (!value) return value;

        // Only uppercase admin notes in this component
        if (name === "adminNote") {
    ...
    // Handle admin note changes with uppercase transformation
    const handleAdminNoteChange = (e) => {
        const { name, value } = e.target;
        const finalValue = shouldUppercase(name, value);
        setAdminNote(finalValue);
    };
