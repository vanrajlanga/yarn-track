...
export const generateAnalyticsData = () => {
	const ordersByStage = {
		received: mockOrders.filter((o) => o.currentStatus === "received")
			.length,
		dyeing: mockOrders.filter((o) => o.currentStatus === "dyeing").length,
		dyeing_complete: mockOrders.filter(
			(o) => o.currentStatus === "dyeing_complete"
		).length,
		conning: mockOrders.filter((o) => o.currentStatus === "conning").length,
		conning_complete: mockOrders.filter(
			(o) => o.currentStatus === "conning_complete"
		).length,
	...
	return {
		...
		processingTimes,
		weeklyThroughput,
		totalActive: mockOrders.filter((o) => o.currentStatus !== "packed")
			.length,
		totalCompleted: mockOrders.filter((o) => o.currentStatus === "packed")
			.length,
	};
};
